...
int sccno[MAXN],lowlink[MAXN],pre[MAXN],scc_cnt,dfs_clock;
vector<int> G[MAXN];
stack<int> s;
...
int main()
{
    ...
    while(T--)
    {
        ...
        for(int i=1;i<=scc_cnt;++i)
            ans=max(ans,dp(i));
        if(ans==n) fin<<"I love you my love and our love save us!\n";
        else fin<<"Light my fire!\n";
    }
    return 0;
}